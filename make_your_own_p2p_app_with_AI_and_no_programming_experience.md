...
account, no sign-up, nobody's server. An AI (Claude) will write the actual
...
## Step 1 -- Get Claude, the AI that will write your code

Claude is an app/website you type requests into ("write me a game where...")
...
Sign up here for a free week: **https://claude.ai/referral/p4jq9u71Ig**

Keep it handy. You'll come back to it in Step 3.
...
## Step 3 -- Ask Claude to build you something

Open Claude. Copy the block below and change the description in the middle
...
Claude will write back one long file. You don't need to read it or
understand it. Save it (download it, or copy the text into a notes app and
...
own phone (everyone runs their own copy). If the app you asked Claude for
...
- **Your app doesn't show your friend, or theirs doesn't show you** -- give
  ...
  see one) and paste it back to Claude along with "this isn't working, here's
...
Claude and asking it to fix it is exactly what people who've coded for
decades do too.
